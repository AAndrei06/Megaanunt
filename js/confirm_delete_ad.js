...
if (theme1 == "dark"){
		...
		document.querySelector('.container-delete').style.backgroundColor = "#242526";
		document.getElementById('first-words').style.color = "#9fa2a6";
		...
		document.querySelector('.container-delete').style.backgroundColor = "white";
		document.getElementById('first-words').style.color = "#3b4a59";
		/* Common */
