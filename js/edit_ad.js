...
if (theme1 == "dark"){
		...
		document.querySelector('.create-ad-form').style.backgroundColor = "#242526";
		document.querySelector('.title-of-form-post').style.color = "whitesmoke";
		document.querySelectorAll('.checkbox-info').forEach((category) =>{
			category.style.color = "lightgray";
		})

		document.querySelectorAll('.input-element-field').forEach((input) => {
			input.style.backgroundColor = "#3a3b3c";
			input.style.color = "whitesmoke";
			input.style.border = "1px solid gray";
		})

		document.querySelectorAll('.title-of-section-ad').forEach((title) => {
		...
		document.querySelector('.create-ad-form').style.backgroundColor = "white";
